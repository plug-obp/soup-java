...
public class EnabledExpression extends UnaryExpression {
    public EnabledExpression(Expression operand, Position position) {
        super("enabled", operand, position);
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof EnabledExpression)) return false;
