...
public class StatementInterpreterTest {
    ...
    void testIfNoBoolCond() throws Exception {
        ...
        var env0 = new RuntimeEnvironment(
                ...
                new HashMap<>(Map.of("x", 23)));
        assertThrows(RuntimeException.class, () -> env0.model.accept(si, env0));
        assertEquals(23, env0.lookup("x"));
    }
